...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(canConstructRansomNote(ransomNote, magazine));
    }


    private static boolean canConstructRansomNote(String ransomNote, String magazine) {
        ...
        // Make the count maps.
        HashMap<Character, Integer> ransomNoteCounts = makeCountsMap(ransomNote);
        HashMap<Character, Integer> magazineCounts = makeCountsMap(magazine);
    ...
    private static HashMap<Character, Integer> makeCountsMap(String s) {
